...
def p_non_stationary(n, t, k_on, k_off, k_syn, k_d):
    ...
    for r in range(0, n+1):
        ...
        logging.debug("sc.hyp1f1(-k_on + r, 1 - k_on - k_off + r, k_syn*np.exp(-t): {}".format(part_a5))
...
plt.show()
plt.close(1)
# logging.debug(sc.gamma(0))

# logging.debug(sc.poch(1 - k_on - k_off, 0))
# logging.debug(sc.poch(1 - k_on - k_off, 1))
# logging.debug(sc.poch(1 - k_on - k_off, 2))
