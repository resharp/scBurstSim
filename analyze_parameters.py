...
def label_distribution(label, df_counts, strategy, params, nr_cells):

    return distribution("real_count", df_counts, strategy, params, nr_cells, filter_label=True, label=label)


def stationary_distribution(df_counts, strategy, params, nr_cells):
